...
**Jika Anda memerlukan tambahan module lagi dalam repo atau Jika Anda menemukan bug, silahkan report di group [@AnonDevilMY] (https://t.me/SanzuCodingMY)**
...
#### Deploy in your VPS
````bash
git clone https://github.com/AnonDevils/File-Sharing-Anon
cd File-Sharing-Anon
pip3 install -r requirements.txt
cp sample_config.env config.env
# edit config.env Anda dan isi VARS menggunakan nano config.env CTRL + S untuk menyimpan VARS Anda, 
# gunakan CTRL + X untuk keluar dan kembali ke direktori File-Sharing-Anon
bash start
````
...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/AnonDevils/File-Sharing-Anon/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/AnonDevils/File-Sharing-Anon/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
...
- Thanks To [CodeXBotz](https://github.com/AnonDevils/File-Sharing-Anon)
- Our Support Group Members

### Licence
[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](http://www.gnu.org/licenses/gpl-3.0.en.html)  

[FILE-SHARING-ANON](https://github.com/AnonDevils/File-Sharing-Anon/) is Free Software: You can use, study share and improve it at your
